...
def test_build_stage_dag_simple():
    ...
    from maple.core.calibration.inference_comparison import _build_stage_dag
...
def test_posterior_to_prior_spec_lognormal():
    ...
    from maple.core.calibration.inference_comparison import _posterior_to_prior_spec
