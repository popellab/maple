...
def test_qsp_validate_help():
    """Test that qsp-validate command is available and shows help."""
    result = subprocess.run(["qsp-validate", "--help"], capture_output=True, text=True)
    assert result.returncode == 0
