...
def _build_schema_overview() -> str:
    ...
    lines = [
        ...
        "├── primary_data_source: {doi, source_tag, title, authors, year, source_relevance}",
        f"│   └── source_relevance: {{{', '.join(sra_fields)}}}",
        "├── secondary_data_sources: [{doi|url, source_tag, ..., source_relevance}]",
