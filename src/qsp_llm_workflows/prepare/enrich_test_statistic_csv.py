...
def main():
    ...
    parser.add_argument('partial_csv', type=Path, help='CSV with test_statistic_id, required_species, derived_species_description')
    parser.add_argument('model_context_file', type=Path, help='Text file with model context')
    parser.add_argument('scenario_yaml', type=Path, help='Scenario YAML with scenario_context and indication')
