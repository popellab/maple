...
def create_parameter_extraction_prompt(
    parameter_name: str, 
    parameter_units: str, 
    ...
    """
    Create a parameter extraction prompt using the new assembly system.
    
    This function maintains backward compatibility with existing code.
    """
    assembler = PromptAssembler(base_dir)
    
    # Prepare parameter info block
    parameter_info = f"""[Parameter name, units, and definition will be provided]

**Parameter:** {parameter_name} [{parameter_units}] — {parameter_definition}"""
    ...
    return assembler.assemble_prompt("parameter_extraction", runtime_data)
...
if __name__ == "__main__":
    ...
    # Test parameter extraction prompt
    runtime_data = {
        "PARAMETER_INFO": "Test parameter info",
